...
(function headerAnimation () {
  ...
  document.querySelector(".mnuBtn").onclick = function () {
    if (headerStatus == 0) {
      header.style.WebkitTransform = "translate3d(0, 260px, 0)";
      headerTop.style.WebkitTransform = "translate3d(0, -260px, 0)";
      ...
      headerTop.style.WebkitTransform = "translate3d(0, 0, 0)";
